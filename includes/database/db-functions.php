...
function x_invoice_create_or_update_tables()
{
    ...
    $sql_operation_data = "CREATE TABLE $operation_data_table (
        ...
        discount_total_amount decimal(60,0),
        discount_total_percentage decimal(60,0),
        payment_method varchar(50) NOT NULL,
        customer_id mediumint(9) NOT NULL,
        order_total_pure decimal(60,0) NOT NULL,
    ...
    $sql_data_lookup = "CREATE TABLE $data_lookup_table (
        ...
        product_net_price decimal(60,0) NOT NULL,
        product_total_price decimal(60,0) NOT NULL,
        customer_id mediumint(9) NOT NULL,

...
function x_invoice_orders_page()
{
    ...
    if (isset($_GET['page']) &&  $_GET['page'] == 'xi-orders-list' ) {
        echo $_GET['page'] . '<br>';
    }
    if (isset($_GET['page']) &&  $_GET['page'] == 'xi-orders-list' && isset($_GET['edit_mode']) && $_GET['edit_mode'] === 1) {
        echo $_GET['page'] . '<br>';
    }
    print_r($_GET);

    if (!isset($_GET['invoice_id']) && isset($_GET['page']) &&  $_GET['page'] == 'xi-orders-list') {
?>
            ...
            <div id="poststuff">
                <div id="post-body" class="metabox-holder columns-2">
                    ...
                    <div id="postbox-container-1" class="postbox-container">
                        <div class="postbox">
                            <a class="button button-secondary" href="admin.php?page=xi-orders-list&edit_mode=1&invoice_id=<?php echo $invoice_id; ?>">ویرایش</a>
